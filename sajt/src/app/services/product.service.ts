...
export class ProductService {
  ...
  private baseUrl = 'https://rentall.projektstudencki.pl/api/products';

  private bookingUrl = 'https://rentall.projektstudencki.pl/api/booking';

  private categoryUrl = 'https://rentall.projektstudencki.pl/api/product_category';
  ...
  searchExternalProduct(productNameFilter: string) {
    return this.httpClient.get<ExternalProduct[]>(`https://rentall.projektstudencki.pl/api/externalProduct`).pipe(map(response => {
      return response;
    }));
  }
  ...
  hasMyBookings(userId: number): Observable<any> {
    return this.httpClient.get<GetResponseProductsPlain>(`https://rentall.projektstudencki.pl/api/booking/myByUser/${userId}`);
  }
